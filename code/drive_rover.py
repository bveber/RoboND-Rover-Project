...
class RoverState:
    def __init__(self):
        ...
        self.time_forward_start = 0  # To record time spent in forward mode to determine if it's stuck
        self.time_stuck_start = 0  # To record time spent in stuck mode to set it back to 'forwards'
        self.time_collecting_start = 0  # To record time spent in 'collect' mode
        ...
        self.rock_angle = None  # The angle to the rock in the image
        self.ground_truth = ground_truth_3d  # Ground truth worldmap
        self.mode = 'stop'  # Current mode (can be forward, stop, stuck or collecting)
